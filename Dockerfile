FROM 883424753239.dkr.ecr.ap-northeast-2.amazonaws.com/apne2-devops-base-jdk:21-alpine3.19
...
RUN echo "#!/bin/sh" >> /service/start.sh \
  ...
  && echo "  java -jar -Dspring.profiles.active=\${ENV} -Djasypt.encryptor.password=aprkTlxlfoq#tmzlstm#0131 /service/service.jar" >> /service/start.sh \
